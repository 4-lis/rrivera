<template>
  <section ref="pinWrapper" class="hero-pin-wrapper relative w-full bg-[#0a0a0a]" style="height: 380vh;">
    <div class="hero-sticky-container sticky top-0 w-full h-screen overflow-hidden flex items-center justify-center bg-[#0a0a0a]">
      ...
      >
        <p class="text-xs tracking-[0.25em] uppercase text-white/40 mb-6 font-medium">El Arquitecto Financiero</p>
        <h1 class="text-5xl md:text-7xl lg:text-[5.5rem] font-serif text-white leading-[0.9] tracking-tight mb-8">
          No dejes que tu casa<br />sea del banco<br />por <span class="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-400">30 años</span>.
        </h1>
        <p class="text-base md:text-xl text-white/40 max-w-2xl font-light leading-relaxed mb-10">
          Soy El Arquitecto Financiero. Aplico inteligencia de datos y rigor matemático<br />para optimizar tu hipoteca y devolverte décadas de libertad financiera.
        </p>

        <!-- Scroll cue -->
        <div class="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-50">
          <span class="text-[10px] tracking-widest uppercase text-white/40">Haz Scroll para descubrir</span>
